...
parser.add_argument('--exp', type=str,
                    default='LA_ACMT_MU_opt2', help='experiment_name')
...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            #threshold = (0.75 - 0.15*ramps.sigmoid_rampup(iter_num, max_iterations))*np.log(2)
            # We find the below strict one is more beneficial for the well-defined LA task. 
            # The threshold can still be optimized regarding different tasks.
            threshold = (0.75 + 0.15*ramps.sigmoid_rampup(iter_num, max_iterations))*np.log(2)
            ...
            # Reported results are on val set
